...
public class Book {
    ...
    public Book(String name, String author, int numberOfPages, String binding) {
        this.name = name;
        this.author = author;
...
class BookInfo {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Война и мир", "Лев Толстой", 1000, "Твердый");
        ...
        Book book2 = new Book("Убить пересмешника", "Харпер Ли", 350, "Мягкий");
        ...
        Book book3 = new Book("Шантарам", "Робертс Грегори Дэвид", 800, "Твердый");
        book3.name = "Шантарам";
        ...
        Book book4 = new Book("Азбука", "Дмитриева В.Г.", 33, "Твердый");
        book4.name = "Азбука";
        ...
        Book book5 = new Book("Книга о вкусной и здоровой пище", "Погожева А.В.", 70, "Мягкий");
