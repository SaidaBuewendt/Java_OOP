...
public class Math {
    ...
    public static Fraction reduction(Fraction input) {
        int numerator = input.getNumerator();
        int denominator = input.getDenominator();
        int gcr = gcdRecursionAlgorithm(numerator, denominator);
        int resultNumerator = numerator / gcr;
        int resultDenominator = denominator / gcr;
